...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _servi_es_services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../serviсes/services */ "./js/serviсes/services.js");
...
function cards() {
    ...
    (0,_servi_es_services__WEBPACK_IMPORTED_MODULE_0__.getResourse)('http://localhost:3000/menu')
        .then(data => {
...
/* harmony import */ var _servi_es_services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../serviсes/services */ "./js/serviсes/services.js");
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            (0,_servi_es_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
                .then(data => {
                    console.log(data);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
    ...
    const tabs = document.querySelectorAll(tabsSelector),
        ...
        tabsHolder = document.querySelector(tabsParentSelector);
